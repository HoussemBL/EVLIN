...
public class FlightsHome {
	...
	public Flights merge(Flights detachedInstance) {
		...
		try {
			Flights result = (Flights) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Flights findById(prov.dao.FlightsId id) {
		log.debug("getting Flights instance with id: " + id);
		try {
			Flights instance = (Flights) sessionFactory.getCurrentSession().get("prov.dao.Flights", id);
			if (instance == null) {
	...
	public List findByExample(Flights instance) {
		log.debug("finding Flights instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("prov.dao.Flights")
