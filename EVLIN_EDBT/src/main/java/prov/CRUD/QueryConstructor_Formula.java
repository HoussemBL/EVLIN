...
public class QueryConstructor_Formula extends QueryConstructor {
	private final static List<List<String>> recomendedjoin = new ArrayList(
			Arrays.asList(Arrays.asList("result", "race"), Arrays.asList("result", "race", "circuit"),
					Arrays.asList("result", "race", "constructor"), Arrays.asList("result", "race", "driver"),
					Arrays.asList("result", "race", "circuit", "constructor"),
					Arrays.asList("result", "race", "circuit", "driver"), Arrays.asList("result", "constructor"),
					Arrays.asList("result", "constructor", "driver")

	, Arrays.asList("result", "driver"), 
	// Arrays.asList("result", "driver","race"), 
	 Arrays.asList("result", "driver","race","constructor"), 
	Arrays.asList("result", "race", "circuit", "constructor", "driver")
	...
	static {
		...
		dep1.put("result.racefk_id", "race.race_id");
	}

	private static final Map<String, String> dep2 = new HashMap<String, String>();

	static {
		dep2.put("result.racefk_id", "race.race_id");
		dep2.put("race.circuitfk_id", "circuit.circuit_id");
	}

	private static final Map<String, String> dep3 = new HashMap<String, String>();

	static {
		dep3.put("result.racefk_id", "race.race_id");
		dep3.put("result.constructorfk_id", "constructor.constructor_id");
	}

	private static final Map<String, String> dep4 = new HashMap<String, String>();

	static {
		dep4.put("result.racefk_id", "race.race_id");
		dep4.put("result.driverfk_id", "driver.driver_id");
	}
	...
	static {
		...
		dep5.put("result.racefk_id", "race.race_id");
		dep5.put("result.constructorfk_id", "constructor.constructor_id");
		dep5.put("race.circuitfk_id", "circuit.circuit_id");
	}
	...
	static {
		...
		dep6.put("result.racefk_id", "race.race_id");
		dep6.put("result.driverfk_id", "driver.driver_id");
		dep6.put("race.circuitfk_id", "circuit.circuit_id");
	}
	...
	static {
		...
		dep7.put("result.constructorfk_id", "constructor.constructor_id");
	}
	...
	static {
		...
		dep8.put("result.constructorfk_id", "constructor.constructor_id");
		dep8.put("result.driverfk_id", "driver.driver_id");
	...
	static {
		...
		dep9.put("result.driverfk_id", "driver.driver_id");
	}
	...
	static {
		...
		dep10.put("result.racefk_id", "race.race_id");
		dep10.put("result.driverfk_id", "driver.driver_id");
	}*/
	...
	static {
		...
		dep10.put("result.driverfk_id", "driver.driver_id");
		dep10.put("result.racefk_id", "race.race_id");
		dep10.put("result.constructorfk_id", "constructor.constructor_id");
	}
	private static final Map<String, String> dep11 = new HashMap<String, String>();

	static {
		dep11.put("result.racefk_id", "race.race_id");
		dep11.put("result.driverfk_id", "driver.driver_id");
		dep11.put("race.circuitfk_id", "circuit.circuit_id");
		dep11.put("result.constructorfk_id", "constructor.constructor_id");
	}

	/*
	 * private static final Map<String, String> dep11 = new HashMap<String,
	 * String>();
	 * 
	 * static { dep11.put("match.country_id", "country.cid");
	 * dep11.put("match.league_id", "league.lid");
	 * dep11.put("match.home_team_api_id", "team.team_api_id");
	 * dep11.put("match.away_team_api_id", "team.team_api_id"); } private static
	 * final Map<String, String> dep12 = new HashMap<String, String>();
	 * 
	 * static { dep12.put("match.country_id", "country.cid");
	 * dep12.put("match.home_player_x1", "player.pid"); }
	 * 
	 * private static final Map<String, String> dep13 = new HashMap<String,
	 * String>();
	 * 
	 * static { dep13.put("match.home_team_api_id", "team.team_api_id");
	 * dep13.put("match.home_player_x1", "player.pid"); }
	 * 
	 * private static final Map<String, String> dep14 = new HashMap<String,
	 * String>();
	 * 
	 * static {
	 * 
	 ...
	 * dep14.put("match.home_player_x1", "player.pid"); }
	 * 
	 * private static final Map<String, String> dep15 = new HashMap<String,
	 * String>();
	 * 
	 * static {
	 * 
	 ...
	 * dep15.put("match.home_player_x1", "player.pid"); }
	 * 
	 * private static final Map<String, String> dep16 = new HashMap<String,
	 * String>();
	 * 
	 * static { dep16.put("match.home_player_x1", "player.pid");
	 * dep16.put("match.away_player_x1", "player.pid"); }
	 * 
	 * private static final Map<String, String> dep17 = new HashMap<String,
	 * String>();
	 * 
	 * static { dep17.put("match.home_player_x1", "player.pid");
	 * dep17.put("match.away_player_x1", "player.pid");
	 * dep17.put("match.home_team_api_id", "team.team_api_id");
	 * dep17.put("match.away_team_api_id", "team.team_api_id"); }
	 * 
	 * private static final Map<String, String> dep18 = new HashMap<String,
	 * String>();
	 * 
	 * static { dep18.put("match.home_player_x1", "player.pid");
	 * dep18.put("match.away_player_x1", "player.pid");
	 * dep18.put("match.home_team_api_id", "team.team_api_id");
	 * dep18.put("match.away_team_api_id", "team.team_api_id"); }
	 * 
	 * private static final Map<String, String> dep19 = new HashMap<String,
	 * String>();
	 * 
	 * static { dep19.put("match.home_player_x1", "player.pid");
	 * dep19.put("match.away_player_x1", "player.pid");
	 * dep19.put("match.home_team_api_id", "team.team_api_id");
	 * dep19.put("match.away_team_api_id", "team.team_api_id");
	 * dep19.put("match.league_id", "league.lid"); }
	 * 
	 * private static final Map<String, String> dep20 = new HashMap<String,
	 * String>();
	 * 
	 * static { dep20.put("match.away_team_api_id", "team.team_api_id"); }
	 */

	private final static List<Map<String, String>> dependencies = new ArrayList(
			Arrays.asList(dep1, dep2, dep3, dep4, dep5, dep6, dep7, dep8, dep9,
					dep10 , dep11/*, dep12, dep13, dep14,dep15, dep16, dep17,
							 * dep18, dep19
							 */));

	private final static List<String> circuitlist = Arrays.asList("circuit_ref", "circuit_name", "circuit_location",
			"circuit_lat", "circuit_longi", "circuit_id");
	private final static List<String> racelist = Arrays.asList("race_year", "round", "race_name", "race_date",
			"circuitfk_id", "race_id");

	private final static List<String> constructorlist = Arrays.asList("constructor_ref", "constructor_name","constructor_nationality",
			"constructor_id");
	private final static List<String> driverlist = Arrays.asList("driver_code", "driver_forename", "driver_surname",
			"driver_id");

	private final static List<String> resultAtts = new ArrayList(
			Arrays.asList("drivers_number", "grid", "final_position", "position_status", "position_order", "points",
					"laps_done", "elapsedtime_ms", "fastest_lap", "rank", "fastest_lap_time", "fastest_lap_speed",
					"status", "stops_number", "racefk_id", "driverfk_id", "constructorfk_id"));

	public QueryConstructor_Formula(QueryForm query, String relevantfield) {
		super();
	...
	public QueryConstructor_Formula() {
		super();
	...
	private List<String> AddAtts(List<String> setAtt, List<String> res, List<String> tables) {
		...
		different.removeAll(similar);
		/*
		 * if (different.isEmpty()) { if (Collections.frequency(similar, "team")
		 * >1) {setAtt.add("T2.team_short_name");} else {
		 * setAtt.add("P"+Collections.frequency(similar,
		 * "player")+".player_name"); } } else {
		 */
		for (String table : different) {
			if (table.equals("driver")) {

				setAtt.add("driver_code");
			} else {
				if (table.equals("constructor")) {
					// n = rand.nextInt(3) + 0;
					setAtt.add("constructor_ref");
				} else if (table.equals("race")) {

					setAtt.add("race_id");
				} else {

					setAtt.add("circuit_ref");
				}
			}
		}
		// }
	...
	private List<String> AddAtts1(List<String> setAtt, List<String> res, List<String> tables) {
		...
		if (different.isEmpty()) {
			...
			for (String table : different) {
				if (table.equals("circuit")) {

					setAtt.add("circuit_name");

				} else if (table.equals("constructor")) {

					setAtt.add("constructor_name");
	...
	public Map<String, String> UpdateConds(Map<String, String> condAtt) {
		...
		for (Map.Entry<String, String> entry : condAtt.entrySet()) {
			...
			/*
			 * if (entry.getKey().startsWith("not,")) { if
			 * (teamAtts.contains(entry.getKey().split(",")[1])) { res.put(
			 * "not, T1." + entry.getKey().split(",")[1], entry.getValue()); }
			 * else if (playerAtts.contains(entry.getKey().split(",")[1])) {
			 * res.put("not, P1." + entry.getKey().split(",")[1],
			 * entry.getValue()); } else res.put(entry.getKey(),
			 * entry.getValue()); } else { if
			 * (teamAtts.contains(entry.getKey())) {
			 * 
	...
	private List<String> UpdateGroupBy(List<String> grp) {
		...
		for (String entry : grp) {
			/*
			 * if (teamAtts.contains(entry)) { res.add("T1." + entry); } else if
			 * (playerAtts.contains(entry)) { res.add("P1." + entry); } else
			 */
			res.add(entry);
	...
	private List<String> UpdateAtts(List<String> setatts) {
		...
		for (String att : setatts) {
			/*
			 * if (teamAtts.contains(att)) res.add("T1." + att); else if
			 * (playerAtts.contains(att)) { res.add("P1." + att); } else
			 */
			res.add(att);
	...
	public Map<String, String> GetJoinConds(Map<String, String> conds) {
		...
		int index = 0;
		Set<String> current_tables= new HashSet<String>();
		for (String tab: queryBean.getTables())
		{
			String xx=tab/*.trim()*/.replaceAll("\\s","");
			current_tables.add(xx);
		}
		
		ArrayList<String> current_tables2 = new ArrayList<String>();
		current_tables2.addAll(current_tables);
		for (List<String> elt : recomendedjoin) {
			find = false;
		

			find = equalityList(elt, /*queryBean.getTables()*/current_tables2);
			if (find) {
		...
		if ( possibleindex.size() == 1) {
			dep = dependencies.get(possibleindex.get(0));
		} else {
	...
	/**** update names of airports for case of duplication ***/
	...
	private List<String> AddDimkey(List<String> setAtt, List<String> res, List<String> tables) {
		...
		if (different.isEmpty()) {
			...
			for (String table : different) {
				if (table.equals("driver")) {
					setAtt.add("driver_id");
				} else if (table.equals("circuit")) {
					setAtt.add("circuit_id");
				} else if (table.equals("race")) {
					setAtt.add("race_id");
				} else if (table.equals("constructor")) {
					setAtt.add("constructor_id");
				} else {
					setAtt.add("id");
				}
			}
	...
	public QueryForm drill(QueryForm query, QueryForm Initialuserquery) {
		...
		if (driverlist.contains(currentGranularity)) {
			studiedDimension = "driver";
		} else if (circuitlist.contains(currentGranularity)) {
			studiedDimension = "circuit";
		} else if (racelist.contains(currentGranularity)) {
			studiedDimension = "race";
		} else if (constructorlist.contains(currentGranularity)) {
			studiedDimension = "constructor";
		} else {
			studiedDimension = "result";
		}

		if (studiedDimension.equals("result")) {
			return new QueryForm();
		}

		String newGranularity = "";
		if (studiedDimension.equals("driver")) {

			int index = driverlist.indexOf(currentGranularity);
			if (index < driverlist.size() - 1) {
				newGranularity = driverlist.get(index + 1);
			} else {
				newGranularity = driverlist.get(0);
			}
		} else if (studiedDimension.equals("circuit")) {
			int index = circuitlist.indexOf(currentGranularity);
			if (index < circuitlist.size() - 1) {
				newGranularity = circuitlist.get(index + 1);
			} else {
				newGranularity = circuitlist.get(0);
			}

		} else if (studiedDimension.equals("race")) {
			int index = racelist.indexOf(currentGranularity);
			if (index < racelist.size() - 1) {
				newGranularity = racelist.get(index + 1);
			} else {
				newGranularity = racelist.get(0);
			}
		} else if (studiedDimension.equals("constructor")) {
			int index = constructorlist.indexOf(currentGranularity);
			if (index < constructorlist.size() - 1) {
				newGranularity = constructorlist.get(index + 1);
			} else {
				newGranularity = constructorlist.get(0);
			}
		}
		...
		if (!newGranularity.isEmpty()) {
			for (String att : query.getSelectedAtt()) {
				...
				/*
				 * if ((currentselectattribute.equals("code") &&
				 * att1.equals("uniqueplayer")) ||
				 * (currentselectattribute.equals("uniqueplayer") &&
				 * att1.equals("code"))) { newSelectionpart.add(newGranularity);
				 * } else
				 */ if (currentselectattribute.equals(att1)) {
			...
			for (String grp : query.getGroupbyAtt()) {
				...
				/*
				 * if ((currentGranularity.equals("code") &&
				 * grp1.equals("uniqueplayer")) ||
				 * (currentGranularity.equals("uniqueplayer") &&
				 * grp1.equals("code"))) { newGrouppart.add(newGranularity); }
				 * else
				 */ if (currentGranularity.equals(grp1)) {
	...
	public String findTable(String colName) {
		if (driverlist.contains(colName))
			return "driver";
		else if (constructorlist.contains(colName))
			return "constructor";
		else if (circuitlist.contains(colName))
			return "circuit";
		else if (racelist.contains(colName))
			return "race";
		else
			return "result";
	}
	...
	private List<String> Reformation(QueryForm query, List<String> newSelectionpart) {
		...
		/*
		 * if (duplicaTabs) { String oldTable = ""; for (String cond :
		 * query.getCondAtt().keySet()) { if (cond.matches("*\\d.*")) { oldTable
		 * = cond.split(Pattern.quote("."))[0]; }
		 * 
		 * if (oldTable.equals("P1")) { tableAbbreviation = "P2"; } else if
		 * (oldTable.equals("T1")) { tableAbbreviation = "T2"; } else { if
		 * (playerAtts.contains(cond)) { tableAbbreviation = "P1"; } else
		...
		for (String att : newSelectionpart) {
			if (circuitlist.contains(att)) {
				if (!tableAbbreviation.isEmpty()) {
					result.add(tableAbbreviation + "." + att);
				} else {
					String att1 = "circuit." + att;
					result.add(att1);
				}
			} else if (constructorlist.contains(att)) {
				String att1 = "constructor." + att;
				result.add(att1);
			} else if (driverlist.contains(att)) {
				String att1 = "driver." + att;
				result.add(att1);
			} else if (racelist.contains(att)) {
				String att1 = "race." + att;
				result.add(att1);
			} else if (resultAtts.contains(att)) {
				String att1 = "result." + att;
				result.add(att1);
			}
	...
	public QueryForm avoidDoublecolumn(QueryForm query, boolean tableRedundancy) {
		...
		for (String table : query.getTables()) {
			if (table.equals("driver")) {
				...
				for (String att : driverlist) {
					// if (!att.equals("id")) {
					updatedSelectionclause.add("driver" + "." + att);
				}
				// }

			} else if (table.equals("constructor")) {

				for (String att : constructorlist) {
					// if (!att.equals("id")) {

					updatedSelectionclause.add("constructor." + att);
					// }
				}
				// i++;
			} else if (table.equals("race")) {

				for (String att : racelist) {
					// if (!att.equals("id")) {

					updatedSelectionclause.add("race." + att);
					// }
				}
				// i++;
			}
				...
				for (String att : circuitlist) {
					// if (!att.equals("id")) {
					updatedSelectionclause.add("circuit" + "." + att);
					// }
				}
			}

			else {
				for (String att : resultAtts) {
					// if (!att.equals("id")) {
					updatedSelectionclause.add("result" + "." + att);
					// }
				}
			}
