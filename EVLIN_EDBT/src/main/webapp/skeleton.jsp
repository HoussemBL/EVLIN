			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<html:form   action="/query.do" focus="formulation"  focusIndex="FacetForm" method="GET" >		
						...
						<logic:iterate name="attList" id="att" scope="session">
						   <nested:hidden styleId="beana" property="value"/>
							<li><a href="index.html"> <i class="fa fa-dashboard fa-fw"></i> <bean:write name="att"
								...
								<ul class="nav nav-second-level">
									...
									<logic:iterate name="attLi" id="facestList">
										...
										<li><a><bean:define name="facestList"
													id="beana" property="value" /> 	
												<bean:define name="facestList" property="key"
													id="keybean"  /> 		
...
parse("usa/VegaUSA.json");
				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bell fa-fw"></i> SQL query Panel
						</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="list-group">
								<a href="#" class="list-group-item"> <i
									class="fa fa-comment fa-fw"></i> Your SQL query  </span>
								</a>
							</div>
							<!-- /.list-group -->
						...
						<div class="panel-footer">
							<div class="input-group">
								<input id="btn-input" type="text" class="form-control input-sm"
									placeholder="Type your query here..." /> <span
